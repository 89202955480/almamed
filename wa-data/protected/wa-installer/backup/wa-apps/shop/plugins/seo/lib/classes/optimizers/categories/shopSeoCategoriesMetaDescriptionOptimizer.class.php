...
class shopSeoCategoriesMetaDescriptionOptimizer extends shopSeoMetaDescriptionOptimizer
{
    ...
    protected function getTemplate()
    {
        ...
        $source_description = $this->category_response->getMetaDescription();
        ...
        foreach (array($current_storefront, $general_storefront) as $storefront)
        {
            ...
            if ($subcategories_enable)
            {
                ...
                while ($_category['parent_id'])
                {
                    ...
                    $template->setContent($_category_settings['subcategories_meta_description']);
            ...
            $template->setContent($_settings['categories_meta_description']);
