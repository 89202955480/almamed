( function ($) {
    ...
    $.reports = {
        ...
        cartsAction: function() {
            ...
            $("#reportscontent").load('?plugin=carts&module=report&action=carts'+this.getTimeframeParams());
        },

        cartsAllAction: function() {
            this.setActiveTop('carts');
            $("#reportscontent").load('?plugin=carts&module=report&action=carts&all=1'+this.getTimeframeParams());
        },
