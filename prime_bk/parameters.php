...
<form action="" method="post" >
	...
	<table width="100%" id="param">
		...
		?>
		<tr>
			<td><span class="tooltip"><?php echo __("Cron command"); ?><span><?php echo __("Copy and Past it to cron in hosting control panel"); ?></span></span></td>
			<td><textarea readonly="readonly" style="height: 50px;">php <?php echo dirname(__FILE__);?>/backup_cron.php</textarea></td>
		</tr>
		<tr>
			<td></td>
