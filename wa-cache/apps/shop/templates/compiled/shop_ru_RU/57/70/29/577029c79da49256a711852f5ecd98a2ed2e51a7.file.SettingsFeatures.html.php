<?php /* Smarty version Smarty-3.1.14, created on 2016-12-06 16:48:03
         compiled from "/home/almamed/web/almamed.su/public_html/wa-apps/shop/templates/actions/settings/SettingsFeatures.html" */ ?>
<?php /*%%SmartyHeaderCode:13246537515846c193e9b263-18137346%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '577029c79da49256a711852f5ecd98a2ed2e51a7' => 
    array (
      0 => '/home/almamed/web/almamed.su/public_html/wa-apps/shop/templates/actions/settings/SettingsFeatures.html',
      1 => 1481026245,
      2 => 'file',
    ),
    ...
    'aff9956ea5d334fc16856349d288cab90b46aab1' => 
    array (
      0 => '/home/almamed/web/almamed.su/public_html/wa-apps/shop/templates/includes/featuresValuesTypes.html',
      1 => 1481026054,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13246537515846c193e9b263-18137346',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5846c19426b1a0_34831828',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5846c19426b1a0_34831828')) {function content_5846c19426b1a0_34831828($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/almamed/web/almamed.su/public_html/wa-system/vendors/smarty3/plugins/modifier.regex_replace.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./SettingsFeaturesFeatureList.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '13246537515846c193e9b263-18137346');
content_5846c193f0f363_84614694($_smarty_tpl);
...
<!-- <?php $_smarty_tpl->_capture_stack[0][] = array("feature-template-js", null, null); ob_start(); ?> feature jquery template -->
                <tr data-types="${feature.types.join(" ")}" data-feature="${feature.id}" data-sort="${feature.sort_json}" data-type="${feature.type}" data-selectable="${feature.selectable}" data-multiple="${feature.multiple}" {{if (feature.type=='divider')}} class="gray"{{/if}}>
...
<!-- <?php $_smarty_tpl->_capture_stack[0][] = array("edit-feature-template-js", null, null); ob_start(); ?> edit feature jquery template -->
                <tr data-types="${feature.types.sort().join(" ")}" class="js-inline-edit" data-feature="${feature.id}" data-multiple="${feature.multiple}" data-selectable="${feature.selectable}" data-type="${feature.type}" {{if (feature.type=='divider')}} class="gray"{{/if}}>
                    <td class="min-width"><i class="icon16 sort"></i></td>
                    <td><input type="text" name="feature[${feature.id}][name]" value="${feature.name}"><br>
                    {{if feature.id>0}}
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../../includes/featuresValuesTypes.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('base'=>'/features/feature/value/type/edit/${feature.id}','class'=>"js-action",'available'=>1,'action'=>''), 0, '13246537515846c193e9b263-18137346');
content_5846c1940bb656_95975433($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../../includes/featuresValuesTypes.html" */?>
                        ...
                        <div style="white-space: nowrap;max-height: 500px;overflow-y: auto;overflow-x: hidden;">
...
<li data-value-id="${id}">
    ...
    <input name="feature[${feature.id}][values][${id}][value]" type="text" value="${$.settings.featuresHelper.value(feature_value,"value")}" placeholder="название цвета" {{if feature_value.error}} class="error" title="${feature_value.error.message}" data-original-id="${feature_value.error.original_id}"{{/if}}>
    ...
    #<input name="feature[${feature.id}][values][${id}][code]" type="text" value="${$.settings.featuresHelper.value(feature_value,"hex")}" placeholder="FFFFFF">
...
<input type="text" name="feature[${feature.id}][values][${id}][value]" value="${$.settings.featuresHelper.value(feature_value,"value")}"{{if feature_value.error}} class="error" title="${feature_value.error.message}" data-original-id="${feature_value.error.original_id}"{{/if}}>
...
<!-- <?php $_smarty_tpl->_capture_stack[0][] = array("edit-feature-value-template-js", null, null); ob_start(); ?> edit feature value jquery template -->
                                ...
                                <li data-value-id="${id}">
                                    <i class="icon16 sort"></i>
                                    <input type="text" name="feature[${feature.id}][values][${id}]" value="{{if typeof(feature_value) == 'object'}}${feature_value.value}{{else}}${feature_value}{{/if}}"{{if feature_value.error}} class="error" title="${feature_value.error.message}" data-original-id="${feature_value.error.original_id}"{{/if}}>
                                    <a href="#/features/feature/value/delete/${feature.id}/${id}/" class="js-action" style="display: inline;">
                                        <i class="icon10 delete no-overhanging"></i>
                                    </a>
                                </li>
                        ...
                        <div class="field-group">
                            ...
                            <div class="field">
                                ...
                                <div class="value features no-shift">
                                    <?php /*  Call merged included template "../../includes/featuresValuesTypes.html" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../../includes/featuresValuesTypes.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('class'=>"js-action",'available'=>1,'action'=>''), 0, '13246537515846c193e9b263-18137346');
content_5846c1940bb656_95975433($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../../includes/featuresValuesTypes.html" */?>
                                </div>
                                <div class="value features no-shift">
...
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2016-12-06 16:48:03
...
<?php if ($_valid && !is_callable('content_5846c193f0f363_84614694')) {function content_5846c193f0f363_84614694($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['feature'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['feature']->_loop = false;
 $_smarty_tpl->tpl_vars['id'] = new Smarty_Variable;
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./SettingsFeaturesFeatureValues.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '13246537515846c193e9b263-18137346');
content_5846c19403b940_44737343($_smarty_tpl);
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2016-12-06 16:48:04
         compiled from "/home/almamed/web/almamed.su/public_html/wa-apps/shop/templates/includes/featuresValuesTypes.html" */ ?>
<?php if ($_valid && !is_callable('content_5846c1940bb656_95975433')) {function content_5846c1940bb656_95975433($_smarty_tpl) {?><?php if (!isset($_smarty_tpl->tpl_vars['base']->value)){?><?php $_smarty_tpl->tpl_vars['base'] = new Smarty_variable('', null, 0);?><?php }?>
